...
static rosidl_typesupport_introspection_c__MessageMember Rotate_Goal__rosidl_typesupport_introspection_c__Rotate_Goal_message_member_array[1] = {
  {
    ...
    offsetof(custom_interfaces__action__Rotate_Goal, angle),  // bytes offset in struct
    NULL,  // default value
...
static rosidl_typesupport_introspection_c__MessageMember Rotate_Result__rosidl_typesupport_introspection_c__Rotate_Result_message_member_array[1] = {
  {
    "success",  // name
